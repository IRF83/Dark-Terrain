...
function createMap(){
    ...
    var apitoken = 'pk.eyJ1IjoiaXJmODMiLCJhIjoiY2syeGJ4NGw3MGE4MTNqbzMzeGEzNWkwOCJ9.U8DBLnwlaHcK_hyjg-XOFw' //Enter your API Token - go to 'https://www.mapbox.com/install/' to yours */
    ...
    var darkTerrain = L.tileLayer(mbStyleUrl, {id: 'irf83/ck2xbz4o60cz91bqvd14agl7x', token: apitoken,  attribution: mbAttr});
    ...
    //create the map*/
    var map = L.map('map', {
        center: [28.157563,-82.763197],//Coordinated to center the map
        zoom: 100, //zoom level
